...
**Suggested Implementation to fulfil requirement:** Create a "Catcher CSC" that can send OCPS commands, also possibly augment the OCPS API.
...
**Current shortcomings:** Unsupported, global scale is being implemented already which is a pre-req
